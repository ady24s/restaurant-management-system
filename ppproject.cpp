...
{
    if (orderSize == 0) {
        cout << "Order is empty. Cannot delete item." << endl;
        return;
    }
...
void displayBill(MenuItem **order, int orderSize)
{
    ...
    cout << setw(5) << left << "Qty" << setw(25) << left << "Item" << setw(10) << right << "Price" << endl;
    cout << setfill('-') << setw(40) << "-" << setfill(' ') << endl;
...
{
    cout << "Welcome to ESSPRESSO EXPRESS ! " << endl;
    cout << "Menu:" << endl;
    cout << setw(5) << left << "No." << setw(25) << left << "Item" << setw(25) << right << "Price" << endl;
...
int main()
{
    ...
    do {
        ...
        cout << "1. Add items to the order" << endl;
        cout << "2. Delete an item from the order" << endl;
